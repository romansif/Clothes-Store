<template>
  <Transition name="view">
    <div v-if="autumnCatalog.length === 0" class="pt-45">
    ...
    <ul v-horizontal-scroll v-else class="flex gap-16.5 mt-5 overflow-x-auto whitespace-nowrap no-scrollbar pt-5">
      <AutumnItem v-for="product in autumnCatalog" :product="product" :autumn-catalog="autumnCatalog" />
    </ul>
  </Transition>
</template>
...
import AutumnItem from "@/entities/season-product/ui/AutumnItem.vue";
