...
<template>
  <ul v-if="products.length > 0" class="font-[Montserrat] grid grid-cols-3 gap-x-35 gap-y-10 overflow-y-auto max-h-[700px] no-scrollbar">
    <MyProductsCard />
  </ul>
  <div v-else class="flex justify-center pt-75">
