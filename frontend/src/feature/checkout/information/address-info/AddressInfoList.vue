...
import AddressInfoCard from "@/feature/checkout/information/address-info/AddressInfoCard.vue";
...
<template>
  <ul v-if="userAddressesCity" class="flex flex-col overflow-y-auto no-scrollbar h-[140px] pb-4">
    <AddressInfoCard />
  </ul>
